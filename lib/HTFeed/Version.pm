...
our @EXPORT_OK = qw( get_feed_version short_version long_version );

##################################################
#            HTFeed version strings              #
#  This block is generated by make, do not edit  #
##################################################
my ($vstring,$full_version_string,$production_ok) = (undef,undef,undef);
########### End HTFeed version string ############
