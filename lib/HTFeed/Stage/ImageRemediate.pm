...
Set the field to the given value, but only if the old field is missing or empty
(i.e. there isn't already a value there)
...
Copies old field value to the new field value, but only if the old value is defined
and the new one is either missing or empty.
