...
our @EXPORT_OK   = qw(register_namespaces NS_EAD NS_METS NS_PREMIS1 NS_PREMIS NS_MARC NS_MIX NS_JHOVE NS_XLINK NS_DC NS_XSI SCHEMA_PREMIS SCHEMA_MARC SCHEMA_EAD );
our %EXPORT_TAGS = ( 'namespaces' =>
      [qw(NS_EAD NS_METS NS_PREMIS NS_PREMIS1 NS_MARC NS_MIX NS_JHOVE NS_XLINK NS_DC NS_XSI)],
      'schemas' => 
