...
sub _setdatetime {
    ...
    if ( $self->{datetime} ) {
        ...
        $self->set_error("Mismatched values for field",field => 'datetime',expected => $self->{datetime},actual=>$datetime);
        return 0;
    }
...
sub _setartist {
    ...
    if ( $self->{artist} ) {
        ...
        $self->set_error("Mismatched values for field",field=>'artist',expected => $self->{artist},actual => $artist);
        return 0;
    }
...
sub _setdocumentname {
    ...
    if ( $self->{documentname} ) {
        ...
        $self->set_error("Mismatched values for field",field=>'documentname',expected => $self->{documentname}, actual=>$documentname);
        return 0;
    }
    ...
    unless ( $documentname =~ m|$pattern|i ) {
        $self->set_error("Invalid value for field",field=>'documentname',actual=>$documentname);
        return 0;
    }
